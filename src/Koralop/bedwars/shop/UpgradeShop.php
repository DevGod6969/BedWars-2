...
namespace Koralop\bedwars\shop;
...
class UpgradeShop
{
     ...
     */
    public static function handleTransaction($formId, BedWarsPlayer $player): void
    {
        $playerTeam = $player->getSession()->getTeam();
     ...
     * @param BedWarsPlayer $player
     */
    public static function sendBuyPage($selectedUpgrade, BedWarsPlayer $player): void
    {
        $playerTeam = $player->getSession()->getTeam();
